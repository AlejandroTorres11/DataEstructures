#include "listas_dobles.hpp"

using namespace std;

listas_dobles::~listas_dobles()
{
    NodoLDobles *aux;
    esPrimero();
    while(cabeza)
...
void listas_dobles::insertarNodo(Reserva v, char c)
{
    NodoLDobles *aux;
    char tipoInsercion;
    tipoInsercion=c;
...
/*
void listas_dobles::insertarNodoIntAntes(Reserva v, int posicion)
{
    NodoLDobles *aux;
...
*/
void listas_dobles::borrarNodo(Reserva v,char c)
{
    char tipoBorrado;
    tipoBorrado=c;
...
void listas_dobles::mostrarLista (int orden)
{
    NodoLDobles *aux;
...
bool listas_dobles::listaVacia()
{
    return cabeza == NULL;
}

void listas_dobles::esSiguiente()
{
    if(actual) actual = actual->siguiente;
}

void listas_dobles::esAnterior()
{
    if(actual) actual = actual->anterior;
}

void listas_dobles::esPrimero()
{
    actual=cabeza;
}

void listas_dobles::esUltimo()
{
    actual=fin;
}

bool listas_dobles::esActual()
{
    return actual != NULL;
}

Reserva listas_dobles::valorActual()
{
...
void listas_dobles::generarReservas() {
    int n;
